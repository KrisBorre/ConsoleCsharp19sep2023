...
{
    public class UnitTestArea9feb2024
    {
        [Fact]
        public void Test1()
        {
        ...
        public void Test12()
        {
            LengthInMeter length1 = new LengthInMeter(3, 0);

            LengthInMeter length2 = new LengthInMeter(4, 0);
