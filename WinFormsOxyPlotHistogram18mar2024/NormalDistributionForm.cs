...
namespace WinFormsOxyPlotHistogram18mar2024
{
    public partial class NormalDistributionForm : Form
    {
        ...
        public NormalDistributionForm()
        {
            ...
            Text = "OxyPlot CreateNormalDistribution";
            this.plotView1.Model = plotModel;
        }

        private static PlotModel CreateNormalDistribution(double mean = 0, double std = 1, int n = 1000000)
        {
            ...
            var binBreaks = HistogramHelpers.CreateUniformBins(start: -std * 4, end: std * 4, binCount: 100);
