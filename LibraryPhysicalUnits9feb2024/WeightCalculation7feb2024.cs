namespace LibraryPhysicalUnits9feb2024
{
    public static class WeightCalculation7feb2024
    {
        ...
        /// <returns></returns>
        public static WeightInKilogram9feb2024 Add(IWeight7feb2024 weight1, IWeight7feb2024 weight2)
        {
            double accuracy = Math.Sqrt(Math.Pow(weight1.GetPrecisionInKilogram(), 2) + Math.Pow(weight2.GetPrecisionInKilogram(), 2));
            return new WeightInKilogram9feb2024(weight1.GetInKilogram() + weight2.GetInKilogram(), accuracy);
        }
