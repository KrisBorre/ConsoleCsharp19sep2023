...
namespace LibraryPhysicalUnits9feb2024
{
    ...
    public class WeightInTon9feb2024 : IWeight7feb2024
    {
        private double m_WeightInTon;
        private double m_PrecisionInTon;

        public WeightInTon9feb2024(double weightInTon, double accuracyInTon = 0)
        {
        ...
        {
            WeightInTon9feb2024 result = new WeightInTon9feb2024(this.m_WeightInTon * factor);
            return result;
        }

        public WeightInTon9feb2024 DivideBy(double factor)
        {
            var result = new WeightInTon9feb2024(this.m_WeightInTon / factor, this.m_PrecisionInTon / factor);
            return result;
        }

        public static WeightInTon9feb2024 operator /(WeightInTon9feb2024 a, double factor)
        {
            var result = new WeightInTon9feb2024(a.GetInTon() / factor);
            return result;
        }
