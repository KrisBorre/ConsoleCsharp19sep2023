...
namespace ConsoleIntegration13dec2023
{
    internal class Program
    {
        private static void Main(string[] args)
        {
            #region Integration
            {
                Console.WriteLine("Welkom bij integralen met enum.");
                const int MAX = 5; // 15;

                #region voorbeeld 1 trapezoidal rule
                {
                    NumericalIntegrator13dec2023 integrationTrapezoidal1 = new NumericalIntegrator13dec2023(new Square7oct2023(), 0.0, 1.0);
...
waarde = 0,333984375
                ...
                {
                    NumericalIntegrator13dec2023 integrationTrapezoidal2 = new NumericalIntegrator13dec2023(new ConstantTimesPower7oct2023(4.0, 0.5), 0.0, 1.0, Method.Trapezoidal);
...
waarde = 2,6543247875089127
                ...
                {
                    NumericalIntegrator13dec2023 integration3 = new NumericalIntegrator13dec2023(new Square7oct2023(), 0.0, 1.0, Method.Midpoint);
...
waarde = 0,33332063201747686
                ...
                {
                    NumericalIntegrator13dec2023 integration4 = new NumericalIntegrator13dec2023(new ConstantTimesPower7oct2023(4.0, 0.5), 0.0, 1.0, Method.Midpoint);
...
waarde = 2,6669880584827617
                ...
                #region voorbeeld 5
                {
                    NumericalIntegrator13dec2023 integration5 = new NumericalIntegrator13dec2023(new Sinus7oct2023(), 0.0, Math.PI, Method.Midpoint);
...
waarde = 2,0001253624631214
                ...
                #region voorbeeld 6
                {
                    NumericalIntegrator13dec2023 integration6 = new NumericalIntegrator13dec2023(new Sinus7oct2023(), 0.0, Math.PI, Method.Trapezoidal);
