...
namespace ConsoleInterpolatie13nov2023
{
        ...
        private static void Main(string[] args)
        {
            ...
            #region Interpolation
            {
                #region example 1
                {
                    ...
                    Console.WriteLine("InterpolationLinear");
                    InterpolationLinear7oct2023 myfunc = new InterpolationLinear7oct2023(xx, yy);
...
x_interp = 4,5   y_interp = 1,8042733281328869
                ...
                #region example 2
                {
                    ...
                    Console.WriteLine("InterpolationLinear");
                    InterpolationLinear7oct2023 myfunc = new InterpolationLinear7oct2023(xx3, yy3);
                    for (int i = 0; i < n2 - 1; i++)
                    {
                        double x_interp3 = i + 0.5;
                        double y_interp3 = myfunc.Interp(x_interp3);
...
x_interp = 8,5   y_interp = 3,1097164439836833
                ...
                #region example 4
                {
                    ...
                    Console.WriteLine("InterpolationLinear");
                    InterpolationLinear7oct2023 myfunc2 = new InterpolationLinear7oct2023(xx5, yy5);

                    for (int i = 0; i < n5 - 1; i++)
                    {
                        double x_interp5 = i + 1.5;
                        double y_interp5 = myfunc2.Interp(x_interp5);
...
x_interp5 = 4,5   y_interp5 = 1,9786858746501106
                ...
                #region example 5
                {
                    ...
                    Console.WriteLine("InterpolationPoly");
                    InterpolationPoly7oct2023 myfunc = new InterpolationPoly7oct2023(xx5, yy5, 4);

                    for (int i = 0; i < n5 - 1; i++)
                    {
                        double x_interp5 = i + 1.5;
                        double y_interp5 = myfunc.Interp(x_interp5);
                        double err = myfunc.dy;
...
x_interp5 = 4,5   y_interp5 = 1,9794279150787513   err = -0,0003960493377704738
                ...
                #region example 6
                {
                    ...
                    Console.WriteLine("InterpolationPoly");
                    InterpolationPoly7oct2023 myfunc = new InterpolationPoly7oct2023(xx, yy, 4);
...
x_interp = 8,5   y_interp = 3,1131743463755677   err = -0,000454613916410912
                ...
                #region example 7
                {
                    ...
                    Console.WriteLine("InterpolationRat");
                    InterpolationRat7oct2023 myfunc = new InterpolationRat7oct2023(xx, yy, 4);
...
x_interp = 8,5   y_interp = 3,113145320936315   err = -0,0013939357180694132
                ...
                #region example 8
                {
                    ...
                    Console.WriteLine("InterpolationRat");
                    InterpolationRat7oct2023 myfunc = new InterpolationRat7oct2023(xx12, yy12, 4);
...
x_interp = 5,5   y_interp = 1,6239920562155732   err = -0,0009354739817765753
                ...
                #region example 9
                {
                    ...
                    Console.WriteLine("InterpolationSpline");
                    InterpolationSpline7oct2023 myfunc = new InterpolationSpline7oct2023(xx, yy);
...
x_interp = 8,5   y_interp = 3,1118728451662143
                ...
                #region example 10
                {
                    ...
                    Console.WriteLine("InterpolationSpline");
                    InterpolationSpline7oct2023 myfunc = new InterpolationSpline7oct2023(xx12, yy12);
